...
a.sInstance+"_"+location.pathname))}catch(b){}},fnStateLoadParams:null,fnStateLoaded:null,fnStateSaveCallback:function(a,b){try{(-1===a.iStateDuration?sessionStorage:localStorage).setItem("DataTables_"+a.sInstance+"_"+location.pathname,JSON.stringify(b))}catch(c){}},fnStateSaveParams:null,iStateDuration:7200,iDeferLoading:null,iDisplayLength:10,iDisplayStart:0,iTabIndex:0,oClasses:{},oLanguage:{oAria:{sSortAscending:": activar para classificar ascendente coluna",sSortDescending:": activar para classificar descendente coluna"},
oPaginate:{sFirst:"Primeira",sLast:"Ultima",sNext:"Próximo",sPrevious:"Anterior"},sEmptyTable:"Sem dados disponíveis na tabela",sInfo:"Mostrando _START_ de _END_ dos _TOTAL_ registros",sInfoEmpty:"Mostrando 0 de 0 dos 0 registros",sInfoFiltered:"(filtrado a partir de _MAX_ total registros)",sInfoPostFix:"",sDecimal:"",sThousands:",",sLengthMenu:"Mostrando _MENU_ registros",sLoadingRecords:"Carregando...",sProcessing:"Processando...",sSearch:"Procurar:",sSearchPlaceholder:"",sUrl:"",sZeroRecords:"Nenhum registro correspondente encontrado"},oSearch:h.extend({},
